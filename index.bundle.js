...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_printList_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/printList.js */ \"./src/modules/printList.js\");\n/* harmony import */ var _modules_scoresClass_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/scoresClass.js */ \"./src/modules/scoresClass.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\n\nconst addScoreBtn = document.querySelector(\n  '.leaderboard__wrapper__add__form__btn',\n);\nconst clearScoresBtn = document.querySelector(\n  '.leaderboard__wrapper__scores__header__btn',\n);\nlet getScores = localStorage.getItem('recentScores')\n  ? JSON.parse(localStorage.getItem('recentScores'))\n  : [];\n\n(0,_modules_printList_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(getScores);\n\naddScoreBtn.addEventListener('click', (e) => {\n  e.preventDefault();\n  const name = document.querySelector(\n    '.leaderboard__wrapper__add__form__name-input',\n  ).value;\n  const score = document.querySelector(\n    '.leaderboard__wrapper__add__form__score-input',\n  ).value;\n\n  const newScore = new _modules_scoresClass_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](name, score);\n  newScore.addScore();\n});\n\nclearScoresBtn.addEventListener('click', (e) => {\n  e.preventDefault();\n  localStorage.clear();\n  getScores = [];\n  (0,_modules_printList_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(getScores);\n});\n\n\n//# sourceURL=webpack://webpack_template/./src/index.js?");
